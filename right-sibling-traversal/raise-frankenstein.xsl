...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0"
    ...
    xmlns="http://www.tei-c.org/ns/1.0"   xmlns:pitt="https://github.com/ebeshero/Pittsburgh_Frankenstein"    
    ...
    <!--2018-07-07 ebb: XSLT for right-sibling traversal to raise a single flattened Frankenstein document. -->
    <!--
