#!/bin/bash
# Use Saxon HE to run raise_3.0.xsl
...
## echo /usr/bin/time -l /usr/bin/java $JOPTS -jar $SAX -l -s:$1 -xsl:raise_3.0.xsl -o:$2 $SOPTS
## /usr/bin/time -l /usr/bin/java $JOPTS -jar $SAX -l -s:$1 -xsl:raise_3.0.xsl -o:$2 $SOPTS

echo time /usr/bin/java $JOPTS -jar $SAX -l -s:$1 -xsl:raise_3.0.xsl -o:$2 $SOPTS
time /usr/bin/java $JOPTS -jar $SAX -l -s:$1 -xsl:raise_3.0.xsl -o:$2 $SOPTS
